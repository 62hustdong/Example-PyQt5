...
#         self.root_path = "K:/PROJECT/QT/QT_APP_1/APP/Project/picture"
#         # Widget
...
if __name__ == '__main__':
    ...
    w = QWidget()
    lay = QHBoxLayout(w)
    myRootPath = "K:/PROJECT/QT/QT_APP_1/APP/Project/picture"
    model = QFileSystemModel()
    # model.setRootPath(QDir.rootPath())
    model.setRootPath(myRootPath)
    for dirname in (myRootPath, ):
        view = QTreeView()
        view.setModel(model)
    ...
    # for dirname in (myRootPath, QDir.homePath(), QDir.currentPath()):